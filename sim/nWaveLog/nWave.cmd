...
wvAddSignal -win $_nWave1 -group {"G1" \
{/test/dut/riscv/clk} \
{/test/dut/riscv/instr_mem_addr\[31:0\]} \
}
wvAddSignal -win $_nWave1 -group {"G2" \
}
...
wvGetSignalClose -win $_nWave1
wvReloadFile -win $_nWave1
wvResizeWindow -win $_nWave1 210 497 960 332
wvGetSignalOpen -win $_nWave1
wvDisplayGridCount -win $_nWave1 -off
wvGetSignalClose -win $_nWave1
wvReloadFile -win $_nWave1
wvSetCursor -win $_nWave1 62.648895 -snap {("G1" 2)}
wvSetCursor -win $_nWave1 71.579974 -snap {("G1" 2)}
wvDisplayGridCount -win $_nWave1 -off
wvGetSignalClose -win $_nWave1
wvReloadFile -win $_nWave1
wvDisplayGridCount -win $_nWave1 -off
